"""Normalization, exact hashing, and winnowing fingerprints for lwIP
version/similarity matching. Shared by build_reference_db.py and match_target.py.

NOTE: this algorithm is identical across components (FreeRTOS, Mbed TLS, CMSIS) - kept
that way rather than component-specific. Copied verbatim from the research-component
skill template; no edits. Kept as its own copy per
